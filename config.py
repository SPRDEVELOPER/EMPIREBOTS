...
BOT_TOKEN = getenv("BOT_TOKEN", "8686362489:AAG4BSHYdbRtfofHPciXSdtVGPjrqAszQ_k")
...
BOT_NAME = getenv("BOT_NAME", "𝐄𝐌𝐏𝐈𝐑𝐄 𝑴𝑼𝑺𝑰𝑪 👑")
ASSUSERNAME = getenv("ASSUSERNAME", "@INDIAN_CEO")

# ── Database & logging ─────────────────────────────────────────────────────────
MONGO_DB_URI = getenv("mongodb+srv://EMPIREBOTS:EMPIREBOTS@cluster0.l4sc7fr.mongodb.net/")
...
# ── Git / updates ──────────────────────────────────────────────────────────────
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/EmpireMusic/EmpireMusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN")

# ── Support links ──────────────────────────────────────────────────────────────
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/EmpireMusicSupport")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/EmpireMusicChat")
...
SOUNCLOAD_IMG_URL = "https://files.catbox.moe/zhymxl.jpg"
